function ViewModel() {
    ...
    self.login = function () {
        grecaptcha.ready(function () {
            grecaptcha.execute('6LcFQqgZAAAAAKjvG3DAACEUnb62n2qd44UFiBWX', { action: 'submit' }).then(function (token) {
    ...
    async function createCustomer() {
        await grecaptcha.ready(async function () {
            await grecaptcha.execute('6LcFQqgZAAAAAKjvG3DAACEUnb62n2qd44UFiBWX', { action: 'submit' }).then(function (token) {
                // Add your logic to submit to your backend server here.
                console.log(token);
                var data = {
                    Token: token
        ...
        let customer = await createStripe();
                ...
                .then((result) => {
                    if (result.error) {
                        ...
                        if (result.paymentIntent.status === 'succeeded') {
                            return fetch('/api/billing/stripe-webhook', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
    ...
    function retrieveUpcomingInvoice(customerId, subscriptionId, newPriceId) {
        return fetch('/api/billing/retrieve-upcoming-invoice', {
            method: 'post',
            headers: {
                'Content-type': 'application/json',
            },
    ...
    function updateSubscription(priceId, subscriptionId) {
        return fetch('/api/billing/update-subscription', {
            method: 'post',
            headers: {
                'Content-type': 'application/json',
            },
    ...
    function retrieveCustomerPaymentMethod(paymentMethodId) {
        return fetch('/api/billing/retrieve-customer-payment-method', {
            method: 'post',
            headers: {
                'Content-type': 'application/json',
            },
